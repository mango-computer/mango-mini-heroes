...
public class ScreenCarga extends ScreenManager {
	...
	manager = new AssetManager();
		...
		*/
		...
		manager.load("assets/Texturas/esfera_azul.png", Texture.class);
		manager.load("assets/Texturas/turnoJugadorNegro.png", Texture.class);
		manager.load("assets/Texturas/candadoCerrado.png", Texture.class);

		manager.load("assets/Texturas/turnoJugadorBlanco.png", Texture.class);
