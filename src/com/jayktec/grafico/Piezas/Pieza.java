...
public class Pieza extends Actor {
  ...
  */
	...
	//System.out.println("**** batch.draw " + batch + " pgnPieza=" + pgnPieza);
...
//System.out.println("**** batch.draw 1 ");

    	        } else {

//System.out.println("**** batch.draw 2 ");
	    			...
	    			size=getTextureReg().length;
	    			 ...
	    			 //elapsedTime += (Gdx.graphics.getDeltaTime()*50);
...
//System.out.println(getName()+" - "+sx+" - "+sy);
    ...
    public void move(float x,float y)
    {
        ...
        actionMove.setDuration(0.3f*duracion);
