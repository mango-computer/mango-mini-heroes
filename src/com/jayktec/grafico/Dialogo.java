...
//		super.debug();
		...
		super.getContentTable().row();
		super.getContentTable().add(imagenReina).align(Align.center|Align.center).width(58).height(58);
		//super.getContentTable().row();
		super.getContentTable().add(imagenTorre).align(Align.center|Align.center).width(58).height(58);
		
		super.getContentTable().row();
		super.getContentTable().add(imagenAlfil).align(Align.center|Align.center).width(58).height(58);
		
		super.getContentTable().add(imagenCaballo).align(Align.center|Align.center).width(58).height(58);
