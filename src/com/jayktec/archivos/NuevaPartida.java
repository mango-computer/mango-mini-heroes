...
import com.jayktec.grafico.MarcarSeleccionMenu;
...
public class NuevaPartida extends ScreenManager {
	...
	final MarcarSeleccionMenu msel;
	...
	public NuevaPartida(final Miniheroes game) {
		super(game);
		game1 = game;
		msel = new MarcarSeleccionMenu(game1);
		msel.setSize(16,16);
//		msel.setPosition(425,257);
